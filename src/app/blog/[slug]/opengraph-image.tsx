    ...
    (
      <div
        style={{
          ...
          backgroundImage: "radial-gradient(circle at 100% 0%, #2a221f 0%, #0d0c0c 70%)",
          padding: "80px",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <h1
            style={{
              fontSize: post.title.length > 50 ? "72px" : "84px",
              fontWeight: 800,
              lineHeight: 1.1,
          ...
          <div style={{ display: "flex", alignItems: "center", color: "#a1a1aa", fontSize: "28px" }}>
            <span>{post.date}</span>
