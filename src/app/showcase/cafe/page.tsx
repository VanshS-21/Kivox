...
export default function CafeShowcase() {
  return (
    ...
    >
      <style>
        {`@keyframes kivox-cafe-marquee { from { transform: translateX(0); } to { transform: translateX(-50%); } }`}
      </style>
      {/* NAVIGATION */}
      <nav className="fixed top-12 left-0 right-0 z-40 bg-[#F9F6F0]/80 backdrop-blur-md border-b border-[#2C241B]/10 transition-all duration-300">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 h-20 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-10 text-[11px] font-bold tracking-[0.2em] uppercase">
            <a href="#" className="hover:text-[#9F442B] transition-colors">Shop Coffee</a>
            <a href="#" className="hover:text-[#9F442B] transition-colors">Subscriptions</a>
            <a href="#" className="hover:text-[#9F442B] transition-colors">Wholesale</a>
            <a href="#" className="hover:text-[#9F442B] transition-colors">Locations</a>
            <a href="#" className="hover:text-[#9F442B] transition-colors">Our Story</a>
          </div>

          {/* Actions */}
          <div className="flex items-center gap-6">
            <a href="#" className="hidden md:block text-[11px] font-bold tracking-[0.2em] uppercase hover:text-[#9F442B] transition-colors">
              Account
            </a>
            <button className="flex items-center gap-2 text-[11px] font-bold tracking-[0.2em] uppercase hover:text-[#9F442B] transition-colors">
              Cart (0)
            </button>
            <button className="hidden sm:block px-6 py-3 bg-[#2C241B] text-[#F9F6F0] text-[10px] font-bold tracking-[0.2em] uppercase rounded-full hover:bg-[#9F442B] transition-colors">
              Order Pickup
            </button>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-7 flex flex-col items-start z-10">
            <div className="inline-flex items-center gap-3 px-4 py-2 border border-[#2C241B]/20 rounded-full mb-6">
              <span className="w-2 h-2 rounded-full bg-[#9F442B] animate-pulse" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-12">
              <button className="px-8 py-4 bg-[#2C241B] text-[#F9F6F0] text-xs font-bold tracking-[0.2em] uppercase rounded-full hover:bg-[#9F442B] transition-colors flex items-center justify-center gap-3 group">
                View Menu
            ...
            <div className="bg-white/80 backdrop-blur-md border border-[#2C241B]/10 p-6 rounded-2xl flex flex-col sm:flex-row gap-8 w-full max-w-lg shadow-xl mt-auto">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#2C241B]/80 mb-1">Flagship Cafe</p>
                  <p className="text-sm font-semibold">123 Roaster Ave, Brooklyn</p>
                  <a href="#" className="text-[#9F442B] text-[10px] font-bold tracking-[0.1em] uppercase mt-2 inline-block hover:underline">Get Directions</a>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#2C241B]/80 mb-1">Today&apos;s Hours</p>
                  <p className="text-sm font-semibold">Open • Closes at 7PM</p>
                  <p className="text-[#2C241B]/80 text-[10px] mt-2">Mon-Sun, 7AM - 7PM</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="border-y border-[#2C241B]/10 py-5 overflow-hidden flex whitespace-nowrap bg-[#2C241B] text-[#F9F6F0]">
        <div 
          ...
          style={{ animation: "kivox-cafe-marquee 25s linear infinite" }}
        >
          {[...Array(8)].map((_, i) => (
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 max-w-[1600px] mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
          ...
          <div className="flex flex-col items-start mt-16 sm:mt-0">
            <h2 className="text-[#9F442B] text-[11px] font-bold tracking-[0.3em] uppercase mb-6">Our Philosophy</h2>
            ...
            <div className="grid grid-cols-2 gap-8 w-full border-t border-[#2C241B]/10 pt-12">
              <div>
                ...
                <div className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#2C241B]/80">Partner Countries</div>
              </div>
              <div>
                <div className="text-4xl font-serif mb-2">3.5x</div>
                <div className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#2C241B]/80">Above Fair-Trade Price</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#2C241B] text-[#F9F6F0] py-24 md:py-32">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          <div className="text-center mb-20">
            <h2 className="text-[#F1A37D] text-[11px] font-bold tracking-[0.3em] uppercase mb-6">Our Offerings</h2>
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24">
            {/* Column 1 */}
            <div>
              <h4 className="text-2xl font-serif border-b border-[#F9F6F0]/20 pb-4 mb-8 text-[#F1A37D]">Espresso Bar</h4>
              <ul className="space-y-8">
                <li>
                  ...
                  <p className="text-sm text-[#F9F6F0]/75 font-light leading-relaxed">Double shot of our seasonal Bedford blend.</p>
                </li>
                <li>
                  <div className="flex justify-between items-baseline mb-2">
                  ...
                  <p className="text-sm text-[#F9F6F0]/75 font-light leading-relaxed">Equal parts espresso and steamed milk.</p>
                </li>
                <li>
                  <div className="flex justify-between items-baseline mb-2">
                  ...
                  <p className="text-sm text-[#F9F6F0]/75 font-light leading-relaxed">Espresso with thick, velvety micro-foam.</p>
                </li>
                <li>
                  <div className="flex justify-between items-baseline mb-2">
                  ...
                  <p className="text-sm text-[#F9F6F0]/75 font-light leading-relaxed">Espresso with lightly textured milk. Hot or iced.</p>
                </li>
              </ul>
            </div>
            ...
            {/* Column 2 */}
            <div>
              <h4 className="text-2xl font-serif border-b border-[#F9F6F0]/20 pb-4 mb-8 text-[#F1A37D]">Pour Over</h4>
              <ul className="space-y-8 mb-16">
                <li>
                  ...
                  <p className="text-sm text-[#F9F6F0]/75 font-light leading-relaxed">Ethiopia • Jasmine, Lemon Zest, Raw Honey</p>
                </li>
                <li>
                  <div className="flex justify-between items-baseline mb-2">
                  ...
                  <p className="text-sm text-[#F9F6F0]/75 font-light leading-relaxed">Guatemala • Caramel, Green Apple, Almond</p>
                </li>
              </ul>

              <h4 className="text-2xl font-serif border-b border-[#F9F6F0]/20 pb-4 mb-8 text-[#F1A37D]">Not Coffee</h4>
              <ul className="space-y-8">
                <li>
                  <div className="flex justify-between items-baseline mb-2">
                  ...
                  <p className="text-sm text-[#F9F6F0]/75 font-light leading-relaxed">Ceremonial grade matcha from Uji, Japan.</p>
                </li>
                <li>
                  <div className="flex justify-between items-baseline mb-2">
                  ...
                  <p className="text-sm text-[#F9F6F0]/75 font-light leading-relaxed">House-made spicy chai concentrate with milk.</p>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-20 pt-10 border-t border-[#F9F6F0]/10 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#F9F6F0]/75">Alternative milks available: Oat, Almond, Macadamia (+0.75)</p>
            <button className="px-8 py-4 bg-[#9F442B] text-[#F9F6F0] text-[10px] font-bold tracking-[0.2em] uppercase rounded-full hover:bg-[#F9F6F0] hover:text-[#2C241B] transition-colors">
              Order Ahead
            </button>
          </div>
        </div>
      ...
      <section className="py-32 max-w-[1600px] mx-auto px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-32">
          <div className="flex flex-col justify-center">
            <h2 className="text-[#9F442B] text-[11px] font-bold tracking-[0.3em] uppercase mb-6">Visit Us</h2>
            ...
            <div className="space-y-8">
              <div className="p-8 border border-[#2C241B]/10 rounded-2xl hover:border-[#D26E4B] transition-colors cursor-pointer group">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="px-3 py-1 bg-[#9F442B]/10 text-[#9F442B] text-[10px] font-bold tracking-[0.2em] uppercase rounded-full">Open Now</span>
                </div>
      ...
      {/* WHOLESALE / B2B */}
      <section className="bg-[#9F442B] text-[#F9F6F0] py-32 px-6 md:px-12 text-center">
        <div className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          <button className="px-10 py-5 bg-[#F9F6F0] text-[#9F442B] text-xs font-bold tracking-[0.2em] uppercase rounded-full hover:bg-[#2C241B] hover:text-[#F9F6F0] transition-colors">
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          <div className="flex flex-col">
            <div className="flex flex-col mb-8">
              <span className="text-2xl font-bold tracking-tighter leading-none">BROOKLYN</span>
              <span className="text-[10px] font-semibold tracking-[0.3em] uppercase mt-1 text-[#F1A37D]">Roasting Co.</span>
            </div>
            ...
            <div className="flex gap-4">
              <a href="#" aria-label="Brooklyn Roasting Co. on Instagram" className="w-10 h-10 rounded-full bg-[#F9F6F0]/10 flex items-center justify-center hover:bg-[#9F442B] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="#" aria-label="Email Brooklyn Roasting Co." className="w-10 h-10 rounded-full bg-[#F9F6F0]/10 flex items-center justify-center hover:bg-[#9F442B] transition-colors">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-[#F1A37D] text-[11px] font-bold tracking-[0.2em] uppercase mb-4">Shop</p>
          ...
          <div className="flex flex-col gap-4">
            <p className="text-[#F1A37D] text-[11px] font-bold tracking-[0.2em] uppercase mb-4">About</p>
          ...
          <div className="flex flex-col gap-4">
            <p className="text-[#F1A37D] text-[11px] font-bold tracking-[0.2em] uppercase mb-4">Stay Awake</p>
            ...
            <div className="flex border-b border-[#F9F6F0]/30 pb-2 focus-within:border-[#D26E4B] transition-colors">
              ...
              />
              <button className="text-[10px] font-bold tracking-[0.2em] uppercase hover:text-[#F1A37D] transition-colors shrink-0">
                Sign Up
              </button>
            </div>
          </div>
