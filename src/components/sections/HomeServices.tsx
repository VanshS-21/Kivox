    ...
    >
      ...
      >
        <Container className="relative z-10">
          ...
          >
            <h2 className="max-w-3xl font-sans text-[clamp(2.35rem,5vw,5.5rem)] font-bold leading-[1.02] tracking-[-0.025em] text-foreground">
              What Kivox builds.
            </h2>
          </motion.div>
          ...
          <div>
            {home.services.map((service, idx) => {
              ...
              const distance =
                hoveredIdx !== null ? Math.abs(idx - hoveredIdx) : 0;
