          ...
          {home.services.map((service, idx) => {
            ...
            return (
              ...
              >
                ...
                <motion.div
                  animate={{
                    y: reduce ? 0 : isHovered ? -4 : isSibling ? distance * 2 : 0,
                    rotateX: reduce ? 0 : isHovered ? 0 : isSibling ? distance * 1.2 : 0,
                    scale: reduce ? 1 : isHovered ? 1.01 : isSibling ? 1 - distance * 0.008 : 1,
                    opacity: isHovered ? 1 : isSibling ? Math.max(0.5, 1 - distance * 0.15) : 1,
                    z: reduce ? 0 : isHovered ? 30 : isSibling ? -distance * 10 : 0,
                  }}
                  transition={{
                    duration: 0.5,
                    ease: [0.22, 1, 0.36, 1],
