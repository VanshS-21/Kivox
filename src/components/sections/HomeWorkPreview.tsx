...
> = {
  cafe: {
    ...
    question: "Can visitors see the menu, hours, and location before patience runs out?",
    proof:
...
export function HomeWorkPreview() {
  ...
  return (
    <Section
      className="work-showcase relative isolate overflow-hidden border-y border-border bg-surface-alt"
      spacing="loose"
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[var(--work-stage-bg)]" />
          ...
          <aside className="grid content-start gap-4">
            ...
            <div className="grid gap-3">
              {projects.map((project, index) => {
                ...
                return (
                  <button
                    aria-controls="home-work-preview-panel"
